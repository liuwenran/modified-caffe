...
#include "caffe/layers/slice_half_layer.hpp"

namespace caffe {

template <typename Dtype>
void SliceHalfLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  slice_point_.clear();
  slice_point_.push_back(bottom[0]->num()/2);
...
template <typename Dtype>
void SliceHalfLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SliceHalfLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SliceHalfLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_CLASS(SliceHalfLayer);
REGISTER_LAYER_CLASS(SliceHalf);
