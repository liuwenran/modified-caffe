...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.PQConvolutionParameter pqconvolution_param = 132;
  inline bool has_pqconvolution_param() const;
  inline void clear_pqconvolution_param();
  static const int kPqconvolutionParamFieldNumber = 132;
  inline const ::caffe::PQConvolutionParameter& pqconvolution_param() const;
  inline ::caffe::PQConvolutionParameter* mutable_pqconvolution_param();
  inline ::caffe::PQConvolutionParameter* release_pqconvolution_param();
  inline void set_allocated_pqconvolution_param(::caffe::PQConvolutionParameter* pqconvolution_param);

  // optional .caffe.PQInnerProductParameter pqinner_product_param = 133;
  inline bool has_pqinner_product_param() const;
  inline void clear_pqinner_product_param();
  static const int kPqinnerProductParamFieldNumber = 133;
  inline const ::caffe::PQInnerProductParameter& pqinner_product_param() const;
  inline ::caffe::PQInnerProductParameter* mutable_pqinner_product_param();
  inline ::caffe::PQInnerProductParameter* release_pqinner_product_param();
  inline void set_allocated_pqinner_product_param(::caffe::PQInnerProductParameter* pqinner_product_param);
 ...
 private:
  ...
  inline void set_has_pqconvolution_param();
  inline void clear_has_pqconvolution_param();
  inline void set_has_pqinner_product_param();
  inline void clear_has_pqinner_product_param();
  ...
  ::caffe::PQConvolutionParameter* pqconvolution_param_;
  ::caffe::PQInnerProductParameter* pqinner_product_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class PQConvolutionParameter : public ::google::protobuf::Message {
 public:
  PQConvolutionParameter();
  virtual ~PQConvolutionParameter();

  PQConvolutionParameter(const PQConvolutionParameter& from);

  inline PQConvolutionParameter& operator=(const PQConvolutionParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const PQConvolutionParameter& default_instance();

  void Swap(PQConvolutionParameter* other);

  // implements Message ----------------------------------------------

  PQConvolutionParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const PQConvolutionParameter& from);
  void MergeFrom(const PQConvolutionParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional float gamma = 1 [default = 0.001];
  inline bool has_gamma() const;
  inline void clear_gamma();
  ...
  inline bool has_iter_stop() const;
  inline void clear_iter_stop();
  static const int kIterStopFieldNumber = 3;
  inline float iter_stop() const;
  inline void set_iter_stop(float value);

  // optional float c_rate = 4 [default = 3];
  inline bool has_c_rate() const;
  inline void clear_c_rate();
  static const int kCRateFieldNumber = 4;
  inline float c_rate() const;
  inline void set_c_rate(float value);

  // optional .caffe.FillerParameter weight_mask_filler = 5;
  inline bool has_weight_mask_filler() const;
  inline void clear_weight_mask_filler();
  static const int kWeightMaskFillerFieldNumber = 5;
  inline const ::caffe::FillerParameter& weight_mask_filler() const;
  inline ::caffe::FillerParameter* mutable_weight_mask_filler();
  inline ::caffe::FillerParameter* release_weight_mask_filler();
  inline void set_allocated_weight_mask_filler(::caffe::FillerParameter* weight_mask_filler);

  // optional .caffe.FillerParameter bias_mask_filler = 6;
  inline bool has_bias_mask_filler() const;
  inline void clear_bias_mask_filler();
  static const int kBiasMaskFillerFieldNumber = 6;
  inline const ::caffe::FillerParameter& bias_mask_filler() const;
  inline ::caffe::FillerParameter* mutable_bias_mask_filler();
  inline ::caffe::FillerParameter* release_bias_mask_filler();
  inline void set_allocated_bias_mask_filler(::caffe::FillerParameter* bias_mask_filler);

  // optional .caffe.FillerParameter config_filler = 10;
  inline bool has_config_filler() const;
  inline void clear_config_filler();
  static const int kConfigFillerFieldNumber = 10;
  inline const ::caffe::FillerParameter& config_filler() const;
  inline ::caffe::FillerParameter* mutable_config_filler();
  inline ::caffe::FillerParameter* release_config_filler();
  inline void set_allocated_config_filler(::caffe::FillerParameter* config_filler);

  // optional uint32 classnum = 7 [default = 8];
  inline bool has_classnum() const;
  inline void clear_classnum();
  static const int kClassnumFieldNumber = 7;
  inline ::google::protobuf::uint32 classnum() const;
  inline void set_classnum(::google::protobuf::uint32 value);

  // optional float zeroth = 8 [default = 0.1];
  inline bool has_zeroth() const;
  inline void clear_zeroth();
  static const int kZerothFieldNumber = 8;
  inline float zeroth() const;
  inline void set_zeroth(float value);

  // optional uint32 qstage = 9 [default = 1];
  inline bool has_qstage() const;
  inline void clear_qstage();
  static const int kQstageFieldNumber = 9;
  inline ::google::protobuf::uint32 qstage() const;
  inline void set_qstage(::google::protobuf::uint32 value);

  // @@protoc_insertion_point(class_scope:caffe.PQConvolutionParameter)
 private:
  inline void set_has_gamma();
  inline void clear_has_gamma();
  inline void set_has_power();
  inline void clear_has_power();
  inline void set_has_iter_stop();
  inline void clear_has_iter_stop();
  inline void set_has_c_rate();
  inline void clear_has_c_rate();
  inline void set_has_weight_mask_filler();
  inline void clear_has_weight_mask_filler();
  inline void set_has_bias_mask_filler();
  inline void clear_has_bias_mask_filler();
  inline void set_has_config_filler();
  inline void clear_has_config_filler();
  inline void set_has_classnum();
  inline void clear_has_classnum();
  inline void set_has_zeroth();
  inline void clear_has_zeroth();
  inline void set_has_qstage();
  inline void clear_has_qstage();
  ...
  float iter_stop_;
  float c_rate_;
  ::caffe::FillerParameter* weight_mask_filler_;
  ::caffe::FillerParameter* bias_mask_filler_;
  ::caffe::FillerParameter* config_filler_;
  ::google::protobuf::uint32 classnum_;
  float zeroth_;
  ::google::protobuf::uint32 qstage_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static PQConvolutionParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class PQInnerProductParameter : public ::google::protobuf::Message {
 public:
  PQInnerProductParameter();
  virtual ~PQInnerProductParameter();

  PQInnerProductParameter(const PQInnerProductParameter& from);

  inline PQInnerProductParameter& operator=(const PQInnerProductParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const PQInnerProductParameter& default_instance();

  void Swap(PQInnerProductParameter* other);

  // implements Message ----------------------------------------------

  PQInnerProductParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const PQInnerProductParameter& from);
  void MergeFrom(const PQInnerProductParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:caffe.PQInnerProductParameter)
 private:
  inline void set_has_gamma();
  inline void clear_has_gamma();
  inline void set_has_power();
  ...
  void InitAsDefaultInstance();
  static PQInnerProductParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.PQConvolutionParameter pqconvolution_param = 132;
inline bool LayerParameter::has_pqconvolution_param() const {
  return (_has_bits_[1] & 0x00000800u) != 0;
}
inline void LayerParameter::set_has_pqconvolution_param() {
  _has_bits_[1] |= 0x00000800u;
}
inline void LayerParameter::clear_has_pqconvolution_param() {
  _has_bits_[1] &= ~0x00000800u;
}
inline void LayerParameter::clear_pqconvolution_param() {
  if (pqconvolution_param_ != NULL) pqconvolution_param_->::caffe::PQConvolutionParameter::Clear();
  clear_has_pqconvolution_param();
}
inline const ::caffe::PQConvolutionParameter& LayerParameter::pqconvolution_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.pqconvolution_param)
  return pqconvolution_param_ != NULL ? *pqconvolution_param_ : *default_instance_->pqconvolution_param_;
}
inline ::caffe::PQConvolutionParameter* LayerParameter::mutable_pqconvolution_param() {
  set_has_pqconvolution_param();
  if (pqconvolution_param_ == NULL) pqconvolution_param_ = new ::caffe::PQConvolutionParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.pqconvolution_param)
  return pqconvolution_param_;
}
inline ::caffe::PQConvolutionParameter* LayerParameter::release_pqconvolution_param() {
  clear_has_pqconvolution_param();
  ::caffe::PQConvolutionParameter* temp = pqconvolution_param_;
  pqconvolution_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_pqconvolution_param(::caffe::PQConvolutionParameter* pqconvolution_param) {
  delete pqconvolution_param_;
  pqconvolution_param_ = pqconvolution_param;
  if (pqconvolution_param) {
    set_has_pqconvolution_param();
  } else {
    clear_has_pqconvolution_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.pqconvolution_param)
}

// optional .caffe.PQInnerProductParameter pqinner_product_param = 133;
inline bool LayerParameter::has_pqinner_product_param() const {
  return (_has_bits_[1] & 0x00001000u) != 0;
}
inline void LayerParameter::set_has_pqinner_product_param() {
  _has_bits_[1] |= 0x00001000u;
}
inline void LayerParameter::clear_has_pqinner_product_param() {
  _has_bits_[1] &= ~0x00001000u;
}
inline void LayerParameter::clear_pqinner_product_param() {
  if (pqinner_product_param_ != NULL) pqinner_product_param_->::caffe::PQInnerProductParameter::Clear();
  clear_has_pqinner_product_param();
}
inline const ::caffe::PQInnerProductParameter& LayerParameter::pqinner_product_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.pqinner_product_param)
  return pqinner_product_param_ != NULL ? *pqinner_product_param_ : *default_instance_->pqinner_product_param_;
}
inline ::caffe::PQInnerProductParameter* LayerParameter::mutable_pqinner_product_param() {
  set_has_pqinner_product_param();
  if (pqinner_product_param_ == NULL) pqinner_product_param_ = new ::caffe::PQInnerProductParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.pqinner_product_param)
  return pqinner_product_param_;
}
inline ::caffe::PQInnerProductParameter* LayerParameter::release_pqinner_product_param() {
  clear_has_pqinner_product_param();
  ::caffe::PQInnerProductParameter* temp = pqinner_product_param_;
  pqinner_product_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_pqinner_product_param(::caffe::PQInnerProductParameter* pqinner_product_param) {
  delete pqinner_product_param_;
  pqinner_product_param_ = pqinner_product_param;
  if (pqinner_product_param) {
    set_has_pqinner_product_param();
  } else {
    clear_has_pqinner_product_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.pqinner_product_param)
}
...
// optional float gamma = 1 [default = 0.001];
inline bool PQConvolutionParameter::has_gamma() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void PQConvolutionParameter::set_has_gamma() {
  _has_bits_[0] |= 0x00000001u;
}
inline void PQConvolutionParameter::clear_has_gamma() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void PQConvolutionParameter::clear_gamma() {
  gamma_ = 0.001f;
  clear_has_gamma();
}
inline float PQConvolutionParameter::gamma() const {
  // @@protoc_insertion_point(field_get:caffe.PQConvolutionParameter.gamma)
  return gamma_;
}
inline void PQConvolutionParameter::set_gamma(float value) {
  set_has_gamma();
  gamma_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQConvolutionParameter.gamma)
}

// optional float power = 2 [default = 1];
inline bool PQConvolutionParameter::has_power() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void PQConvolutionParameter::set_has_power() {
  _has_bits_[0] |= 0x00000002u;
}
inline void PQConvolutionParameter::clear_has_power() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void PQConvolutionParameter::clear_power() {
  power_ = 1;
  clear_has_power();
}
inline float PQConvolutionParameter::power() const {
  // @@protoc_insertion_point(field_get:caffe.PQConvolutionParameter.power)
  return power_;
}
inline void PQConvolutionParameter::set_power(float value) {
  set_has_power();
  power_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQConvolutionParameter.power)
}

// optional float iter_stop = 3 [default = 10000];
inline bool PQConvolutionParameter::has_iter_stop() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void PQConvolutionParameter::set_has_iter_stop() {
  _has_bits_[0] |= 0x00000004u;
}
inline void PQConvolutionParameter::clear_has_iter_stop() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void PQConvolutionParameter::clear_iter_stop() {
  iter_stop_ = 10000;
  clear_has_iter_stop();
}
inline float PQConvolutionParameter::iter_stop() const {
  // @@protoc_insertion_point(field_get:caffe.PQConvolutionParameter.iter_stop)
  return iter_stop_;
}
inline void PQConvolutionParameter::set_iter_stop(float value) {
  set_has_iter_stop();
  iter_stop_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQConvolutionParameter.iter_stop)
}

// optional float c_rate = 4 [default = 3];
inline bool PQConvolutionParameter::has_c_rate() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void PQConvolutionParameter::set_has_c_rate() {
  _has_bits_[0] |= 0x00000008u;
}
inline void PQConvolutionParameter::clear_has_c_rate() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void PQConvolutionParameter::clear_c_rate() {
  c_rate_ = 3;
  clear_has_c_rate();
}
inline float PQConvolutionParameter::c_rate() const {
  // @@protoc_insertion_point(field_get:caffe.PQConvolutionParameter.c_rate)
  return c_rate_;
}
inline void PQConvolutionParameter::set_c_rate(float value) {
  set_has_c_rate();
  c_rate_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQConvolutionParameter.c_rate)
}

// optional .caffe.FillerParameter weight_mask_filler = 5;
inline bool PQConvolutionParameter::has_weight_mask_filler() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void PQConvolutionParameter::set_has_weight_mask_filler() {
  _has_bits_[0] |= 0x00000010u;
}
inline void PQConvolutionParameter::clear_has_weight_mask_filler() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void PQConvolutionParameter::clear_weight_mask_filler() {
  if (weight_mask_filler_ != NULL) weight_mask_filler_->::caffe::FillerParameter::Clear();
  clear_has_weight_mask_filler();
}
inline const ::caffe::FillerParameter& PQConvolutionParameter::weight_mask_filler() const {
  // @@protoc_insertion_point(field_get:caffe.PQConvolutionParameter.weight_mask_filler)
  return weight_mask_filler_ != NULL ? *weight_mask_filler_ : *default_instance_->weight_mask_filler_;
}
inline ::caffe::FillerParameter* PQConvolutionParameter::mutable_weight_mask_filler() {
  set_has_weight_mask_filler();
  if (weight_mask_filler_ == NULL) weight_mask_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.PQConvolutionParameter.weight_mask_filler)
  return weight_mask_filler_;
}
inline ::caffe::FillerParameter* PQConvolutionParameter::release_weight_mask_filler() {
  clear_has_weight_mask_filler();
  ::caffe::FillerParameter* temp = weight_mask_filler_;
  weight_mask_filler_ = NULL;
  return temp;
}
inline void PQConvolutionParameter::set_allocated_weight_mask_filler(::caffe::FillerParameter* weight_mask_filler) {
  delete weight_mask_filler_;
  weight_mask_filler_ = weight_mask_filler;
  if (weight_mask_filler) {
    set_has_weight_mask_filler();
  } else {
    clear_has_weight_mask_filler();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.PQConvolutionParameter.weight_mask_filler)
}

// optional .caffe.FillerParameter bias_mask_filler = 6;
inline bool PQConvolutionParameter::has_bias_mask_filler() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void PQConvolutionParameter::set_has_bias_mask_filler() {
  _has_bits_[0] |= 0x00000020u;
}
inline void PQConvolutionParameter::clear_has_bias_mask_filler() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void PQConvolutionParameter::clear_bias_mask_filler() {
  if (bias_mask_filler_ != NULL) bias_mask_filler_->::caffe::FillerParameter::Clear();
  clear_has_bias_mask_filler();
}
inline const ::caffe::FillerParameter& PQConvolutionParameter::bias_mask_filler() const {
  // @@protoc_insertion_point(field_get:caffe.PQConvolutionParameter.bias_mask_filler)
  return bias_mask_filler_ != NULL ? *bias_mask_filler_ : *default_instance_->bias_mask_filler_;
}
inline ::caffe::FillerParameter* PQConvolutionParameter::mutable_bias_mask_filler() {
  set_has_bias_mask_filler();
  if (bias_mask_filler_ == NULL) bias_mask_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.PQConvolutionParameter.bias_mask_filler)
  return bias_mask_filler_;
}
inline ::caffe::FillerParameter* PQConvolutionParameter::release_bias_mask_filler() {
  clear_has_bias_mask_filler();
  ::caffe::FillerParameter* temp = bias_mask_filler_;
  bias_mask_filler_ = NULL;
  return temp;
}
inline void PQConvolutionParameter::set_allocated_bias_mask_filler(::caffe::FillerParameter* bias_mask_filler) {
  delete bias_mask_filler_;
  bias_mask_filler_ = bias_mask_filler;
  if (bias_mask_filler) {
    set_has_bias_mask_filler();
  } else {
    clear_has_bias_mask_filler();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.PQConvolutionParameter.bias_mask_filler)
}

// optional .caffe.FillerParameter config_filler = 10;
inline bool PQConvolutionParameter::has_config_filler() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void PQConvolutionParameter::set_has_config_filler() {
  _has_bits_[0] |= 0x00000040u;
}
inline void PQConvolutionParameter::clear_has_config_filler() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void PQConvolutionParameter::clear_config_filler() {
  if (config_filler_ != NULL) config_filler_->::caffe::FillerParameter::Clear();
  clear_has_config_filler();
}
inline const ::caffe::FillerParameter& PQConvolutionParameter::config_filler() const {
  // @@protoc_insertion_point(field_get:caffe.PQConvolutionParameter.config_filler)
  return config_filler_ != NULL ? *config_filler_ : *default_instance_->config_filler_;
}
inline ::caffe::FillerParameter* PQConvolutionParameter::mutable_config_filler() {
  set_has_config_filler();
  if (config_filler_ == NULL) config_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.PQConvolutionParameter.config_filler)
  return config_filler_;
}
inline ::caffe::FillerParameter* PQConvolutionParameter::release_config_filler() {
  clear_has_config_filler();
  ::caffe::FillerParameter* temp = config_filler_;
  config_filler_ = NULL;
  return temp;
}
inline void PQConvolutionParameter::set_allocated_config_filler(::caffe::FillerParameter* config_filler) {
  delete config_filler_;
  config_filler_ = config_filler;
  if (config_filler) {
    set_has_config_filler();
  } else {
    clear_has_config_filler();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.PQConvolutionParameter.config_filler)
}

// optional uint32 classnum = 7 [default = 8];
inline bool PQConvolutionParameter::has_classnum() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void PQConvolutionParameter::set_has_classnum() {
  _has_bits_[0] |= 0x00000080u;
}
inline void PQConvolutionParameter::clear_has_classnum() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void PQConvolutionParameter::clear_classnum() {
  classnum_ = 8u;
  clear_has_classnum();
}
inline ::google::protobuf::uint32 PQConvolutionParameter::classnum() const {
  // @@protoc_insertion_point(field_get:caffe.PQConvolutionParameter.classnum)
  return classnum_;
}
inline void PQConvolutionParameter::set_classnum(::google::protobuf::uint32 value) {
  set_has_classnum();
  classnum_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQConvolutionParameter.classnum)
}

// optional float zeroth = 8 [default = 0.1];
inline bool PQConvolutionParameter::has_zeroth() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void PQConvolutionParameter::set_has_zeroth() {
  _has_bits_[0] |= 0x00000100u;
}
inline void PQConvolutionParameter::clear_has_zeroth() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void PQConvolutionParameter::clear_zeroth() {
  zeroth_ = 0.1f;
  clear_has_zeroth();
}
inline float PQConvolutionParameter::zeroth() const {
  // @@protoc_insertion_point(field_get:caffe.PQConvolutionParameter.zeroth)
  return zeroth_;
}
inline void PQConvolutionParameter::set_zeroth(float value) {
  set_has_zeroth();
  zeroth_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQConvolutionParameter.zeroth)
}

// optional uint32 qstage = 9 [default = 1];
inline bool PQConvolutionParameter::has_qstage() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void PQConvolutionParameter::set_has_qstage() {
  _has_bits_[0] |= 0x00000200u;
}
inline void PQConvolutionParameter::clear_has_qstage() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void PQConvolutionParameter::clear_qstage() {
  qstage_ = 1u;
  clear_has_qstage();
}
inline ::google::protobuf::uint32 PQConvolutionParameter::qstage() const {
  // @@protoc_insertion_point(field_get:caffe.PQConvolutionParameter.qstage)
  return qstage_;
}
inline void PQConvolutionParameter::set_qstage(::google::protobuf::uint32 value) {
  set_has_qstage();
  qstage_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQConvolutionParameter.qstage)
}
...
// optional float gamma = 1 [default = 0.001];
inline bool PQInnerProductParameter::has_gamma() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void PQInnerProductParameter::set_has_gamma() {
  _has_bits_[0] |= 0x00000001u;
}
inline void PQInnerProductParameter::clear_has_gamma() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void PQInnerProductParameter::clear_gamma() {
  gamma_ = 0.001f;
  clear_has_gamma();
}
inline float PQInnerProductParameter::gamma() const {
  // @@protoc_insertion_point(field_get:caffe.PQInnerProductParameter.gamma)
  return gamma_;
}
inline void PQInnerProductParameter::set_gamma(float value) {
  set_has_gamma();
  gamma_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQInnerProductParameter.gamma)
}

// optional float power = 2 [default = 1];
inline bool PQInnerProductParameter::has_power() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void PQInnerProductParameter::set_has_power() {
  _has_bits_[0] |= 0x00000002u;
}
inline void PQInnerProductParameter::clear_has_power() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void PQInnerProductParameter::clear_power() {
  power_ = 1;
  clear_has_power();
}
inline float PQInnerProductParameter::power() const {
  // @@protoc_insertion_point(field_get:caffe.PQInnerProductParameter.power)
  return power_;
}
inline void PQInnerProductParameter::set_power(float value) {
  set_has_power();
  power_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQInnerProductParameter.power)
}

// optional float iter_stop = 3 [default = 8000];
inline bool PQInnerProductParameter::has_iter_stop() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void PQInnerProductParameter::set_has_iter_stop() {
  _has_bits_[0] |= 0x00000004u;
}
inline void PQInnerProductParameter::clear_has_iter_stop() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void PQInnerProductParameter::clear_iter_stop() {
  iter_stop_ = 8000;
  clear_has_iter_stop();
}
inline float PQInnerProductParameter::iter_stop() const {
  // @@protoc_insertion_point(field_get:caffe.PQInnerProductParameter.iter_stop)
  return iter_stop_;
}
inline void PQInnerProductParameter::set_iter_stop(float value) {
  set_has_iter_stop();
  iter_stop_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQInnerProductParameter.iter_stop)
}

// optional float c_rate = 4 [default = 3];
inline bool PQInnerProductParameter::has_c_rate() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void PQInnerProductParameter::set_has_c_rate() {
  _has_bits_[0] |= 0x00000008u;
}
inline void PQInnerProductParameter::clear_has_c_rate() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void PQInnerProductParameter::clear_c_rate() {
  c_rate_ = 3;
  clear_has_c_rate();
}
inline float PQInnerProductParameter::c_rate() const {
  // @@protoc_insertion_point(field_get:caffe.PQInnerProductParameter.c_rate)
  return c_rate_;
}
inline void PQInnerProductParameter::set_c_rate(float value) {
  set_has_c_rate();
  c_rate_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQInnerProductParameter.c_rate)
}

// optional .caffe.FillerParameter weight_mask_filler = 5;
inline bool PQInnerProductParameter::has_weight_mask_filler() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void PQInnerProductParameter::set_has_weight_mask_filler() {
  _has_bits_[0] |= 0x00000010u;
}
inline void PQInnerProductParameter::clear_has_weight_mask_filler() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void PQInnerProductParameter::clear_weight_mask_filler() {
  if (weight_mask_filler_ != NULL) weight_mask_filler_->::caffe::FillerParameter::Clear();
  clear_has_weight_mask_filler();
}
inline const ::caffe::FillerParameter& PQInnerProductParameter::weight_mask_filler() const {
  // @@protoc_insertion_point(field_get:caffe.PQInnerProductParameter.weight_mask_filler)
  return weight_mask_filler_ != NULL ? *weight_mask_filler_ : *default_instance_->weight_mask_filler_;
}
inline ::caffe::FillerParameter* PQInnerProductParameter::mutable_weight_mask_filler() {
  set_has_weight_mask_filler();
  if (weight_mask_filler_ == NULL) weight_mask_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.PQInnerProductParameter.weight_mask_filler)
  return weight_mask_filler_;
}
inline ::caffe::FillerParameter* PQInnerProductParameter::release_weight_mask_filler() {
  clear_has_weight_mask_filler();
  ::caffe::FillerParameter* temp = weight_mask_filler_;
  weight_mask_filler_ = NULL;
  return temp;
}
inline void PQInnerProductParameter::set_allocated_weight_mask_filler(::caffe::FillerParameter* weight_mask_filler) {
  delete weight_mask_filler_;
  weight_mask_filler_ = weight_mask_filler;
  if (weight_mask_filler) {
    set_has_weight_mask_filler();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.PQInnerProductParameter.weight_mask_filler)
}

// optional .caffe.FillerParameter bias_mask_filler = 6;
inline bool PQInnerProductParameter::has_bias_mask_filler() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void PQInnerProductParameter::set_has_bias_mask_filler() {
  _has_bits_[0] |= 0x00000020u;
}
inline void PQInnerProductParameter::clear_has_bias_mask_filler() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void PQInnerProductParameter::clear_bias_mask_filler() {
  if (bias_mask_filler_ != NULL) bias_mask_filler_->::caffe::FillerParameter::Clear();
  clear_has_bias_mask_filler();
}
inline const ::caffe::FillerParameter& PQInnerProductParameter::bias_mask_filler() const {
  // @@protoc_insertion_point(field_get:caffe.PQInnerProductParameter.bias_mask_filler)
  return bias_mask_filler_ != NULL ? *bias_mask_filler_ : *default_instance_->bias_mask_filler_;
}
inline ::caffe::FillerParameter* PQInnerProductParameter::mutable_bias_mask_filler() {
  set_has_bias_mask_filler();
  if (bias_mask_filler_ == NULL) bias_mask_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.PQInnerProductParameter.bias_mask_filler)
  return bias_mask_filler_;
}
inline ::caffe::FillerParameter* PQInnerProductParameter::release_bias_mask_filler() {
  clear_has_bias_mask_filler();
  ::caffe::FillerParameter* temp = bias_mask_filler_;
  bias_mask_filler_ = NULL;
  return temp;
}
inline void PQInnerProductParameter::set_allocated_bias_mask_filler(::caffe::FillerParameter* bias_mask_filler) {
  delete bias_mask_filler_;
  bias_mask_filler_ = bias_mask_filler;
  if (bias_mask_filler) {
    set_has_bias_mask_filler();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.PQInnerProductParameter.bias_mask_filler)
}

// optional uint32 classnum = 7 [default = 8];
inline bool PQInnerProductParameter::has_classnum() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void PQInnerProductParameter::set_has_classnum() {
  _has_bits_[0] |= 0x00000040u;
}
inline void PQInnerProductParameter::clear_has_classnum() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void PQInnerProductParameter::clear_classnum() {
  classnum_ = 8u;
  clear_has_classnum();
}
inline ::google::protobuf::uint32 PQInnerProductParameter::classnum() const {
  // @@protoc_insertion_point(field_get:caffe.PQInnerProductParameter.classnum)
  return classnum_;
}
inline void PQInnerProductParameter::set_classnum(::google::protobuf::uint32 value) {
  set_has_classnum();
  classnum_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQInnerProductParameter.classnum)
}

// optional float zeroth = 8 [default = 0.1];
inline bool PQInnerProductParameter::has_zeroth() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void PQInnerProductParameter::set_has_zeroth() {
  _has_bits_[0] |= 0x00000080u;
}
inline void PQInnerProductParameter::clear_has_zeroth() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void PQInnerProductParameter::clear_zeroth() {
  zeroth_ = 0.1f;
  clear_has_zeroth();
}
inline float PQInnerProductParameter::zeroth() const {
  // @@protoc_insertion_point(field_get:caffe.PQInnerProductParameter.zeroth)
  return zeroth_;
}
inline void PQInnerProductParameter::set_zeroth(float value) {
  set_has_zeroth();
  zeroth_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQInnerProductParameter.zeroth)
}

// optional uint32 qstage = 9 [default = 1];
inline bool PQInnerProductParameter::has_qstage() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void PQInnerProductParameter::set_has_qstage() {
  _has_bits_[0] |= 0x00000100u;
}
inline void PQInnerProductParameter::clear_has_qstage() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void PQInnerProductParameter::clear_qstage() {
  qstage_ = 1u;
  clear_has_qstage();
}
inline ::google::protobuf::uint32 PQInnerProductParameter::qstage() const {
  // @@protoc_insertion_point(field_get:caffe.PQInnerProductParameter.qstage)
  return qstage_;
}
inline void PQInnerProductParameter::set_qstage(::google::protobuf::uint32 value) {
  set_has_qstage();
  qstage_ = value;
  // @@protoc_insertion_point(field_set:caffe.PQInnerProductParameter.qstage)
}
