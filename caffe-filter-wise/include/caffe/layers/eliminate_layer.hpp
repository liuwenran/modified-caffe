#ifndef CAFFE_ELIMINATE_LAYER_HPP_
#define CAFFE_ELIMINATE_LAYER_HPP_
...
class EliminateLayer : public Layer<Dtype> {
 public:
  explicit EliminateLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
...
#endif  // CAFFE_ELIMINATE_LAYER_HPP_
